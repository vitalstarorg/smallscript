...
class Test_Compiler2(SmallScriptTest):
    ...
    def test520_kwhead(self):
        ...
        ss = "tobj attr11"
        res = Closure().interpret(ss).toPython().compile()(scope)
        ...
        closure.toPython().compile()
        closure.loglevel(4)      # suppress parameter mismatch error message.
        res = closure(scope)
    ...
    def test540_chain(self):
        ...
        ss = "7 |"
        closure = Closure().interpret(ss).toPython().compile(); res = closure(scope)
    ...
    def test600_block_closure(self):
        ...
        ss = "[:param1 | param1]"
        block = Closure().interpret(ss).toPython().compile()
        closure = block(scope)
        ...
        closure = Closure().interpret(ss).toPython().compile(); block = closure(scope)
